...
Route::post('/Usuario/ciclo_escolar/{id}/pasos/promover','ciclecontroller@updatestudents');
Route::post('/Usuario/ciclo_escolar/{id}/pasos/cartera','ciclecontroller@AddPayment');
