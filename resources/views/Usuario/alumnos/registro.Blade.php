          ...
          <form method="post" action{{ url('/Usuario/alumno/resgistrar')}} enctype="multipart/form-data">
            ...
            <div class="card card-nav-tabs card-plain">
              ...
              <div class="text-right">
                <a href="{{ url('/Usuario/alumno/')}}" type="button" class="btn btn-secondary "> <i class="fa fa-angle-left"></i> &nbsp;Regresar</a>
              </div>
                <div class="nav-tabs-navigation">
                  <div class="nav-tabs-wrapper">
                    <ul class="nav nav-tabs" data-tabs="tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#nivel" data-toggle="tab">4) Grupo</a>
                        </li>
                    </ul>
                  </div>
                </div>
