            ...
            <div class="card card-nav-tabs card-plain">
              ...
              <div class="card-body ">
                <div class="tab-content text-center">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="level_id" id="exampleFormControlSelect1" value="{{$actlevel->level->nivel_educativo}}">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control"  name="turno_id" id="exampleFormControlSelect1" value="{{$actlevel->Turn->Turno}}">
                ...
                <label for="exampleFormControlSelect1">Grado</label>
                  <select class="form-control" name="grado_id" id="exampleFormControlSelect1" value="{{$actlevel->grade->grado}}">
              ...
              <div class="form-group">
                <label for="exampleFormControlSelect1">Grupo</label>
                  <select class="form-control" name="grupo_id" id="exampleFormControlSelect1" value="{{$actlevel->group->grupo}}">
